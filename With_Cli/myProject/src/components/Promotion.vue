<template>
    <!-- promotion -->
    <div class="col-xs-12 col-sm-8 top-box">
        <div class="head head-inside">Promotion !</div>
        <p>Naidin Book Center ออกโปรโมชั่นสำหรับหนังสือ Harry Potter ทั้ง 7 ภาค โดยเมื่อ..</p>
        <ul>
